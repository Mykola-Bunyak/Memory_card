...
questions_list.append( Question("Головне місце України?", "Київ ", "Прага", "Париж", "Харків") )
questions_list.append( Question("Хто такий Шевченко Тарас Григорович?", "Поет", "Грут", "Людина Павук", "Президент України") )
...
def next_question():
    cur_question = randint(0, len(questions_list) - 1)             # Збільшуємо індекс питання
    window.total += 1
